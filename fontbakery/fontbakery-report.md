 ...
 * b (U+0062): L<<121.0,130.0>--<120.0,0.0>> and 16 more. [code: found-semi-vertical]
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* jcircumflex (U+0135): X=98.0,Y=2.0 (should be at baseline 0?)
	* jcircumflex (U+0135): X=158.0,Y=1.0 (should be at baseline 0?)
	* jcircumflex (U+0135): X=98.0,Y=2.0 (should be at baseline 0?)
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	* parenleft (U+0028) contains a short segment L<<577.0,800.0>--<574.0,790.0>>
	* parenright (U+0029) contains a short segment L<<-31.0,-100.0>--<-29.0,-90.0>>
	* yen (U+00A5) contains a short segment L<<242.0,232.0>--<245.0,245.0>>
	* yen (U+00A5) contains a short segment L<<380.0,246.0>--<377.0,232.0>>
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* bracketleft (U+005B): X=363.0,Y=702.0 (should be at cap-height 700?)
	* bracketleft (U+005B): X=258.0,Y=702.0 (should be at cap-height 700?)
	* bracketleft (U+005B): X=258.0,Y=-1.0 (should be at baseline 0?)
	* bracketleft (U+005B): X=363.0,Y=-1.0 (should be at baseline 0?)
	* bracketright (U+005D): X=119.0,Y=-1.0 (should be at baseline 0?)
	* bracketright (U+005D): X=223.0,Y=-1.0 (should be at baseline 0?)
	* bracketright (U+005D): X=223.0,Y=702.0 (should be at cap-height 700?)
	* bracketright (U+005D): X=119.0,Y=702.0 (should be at cap-height 700?)
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	* parenleft (U+0028) contains a short segment L<<463.0,800.0>--<463.0,791.0>>
	* parenright (U+0029) contains a short segment L<<44.0,-100.0>--<44.0,-91.0>>
	* paragraph (U+00B6) contains a short segment L<<285.0,286.0>--<270.0,286.0>>
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* sterling (U+00A3) contains a short segment B<<294.0,291.0>-<295.0,285.0>-<295.0,278.0>>
	* sterling (U+00A3) contains a short segment B<<148.0,279.0>-<148.0,285.0>-<147.0,291.0>>
	* paragraph (U+00B6) contains a short segment L<<286.0,276.0>--<265.0,276.0>>
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	* parenleft (U+0028) contains a short segment L<<451.0,800.0>--<451.0,792.0>>
	* parenright (U+0029) contains a short segment L<<43.0,-100.0>--<43.0,-92.0>>
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* sterling (U+00A3) contains a short segment B<<154.0,279.0>-<155.0,285.0>-<155.0,291.0>>
	* paragraph (U+00B6) contains a short segment L<<291.0,276.0>--<270.0,276.0>>
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	* Q (U+0051): X=403.0,Y=-2.0 (should be at baseline 0?)
	* bracketleft (U+005B): X=452.0,Y=702.0 (should be at cap-height 700?)
	* bracketleft (U+005B): X=348.0,Y=702.0 (should be at cap-height 700?)
	* bracketleft (U+005B): X=208.0,Y=-1.0 (should be at baseline 0?)
	* bracketleft (U+005B): X=312.0,Y=-1.0 (should be at baseline 0?)
	* bracketright (U+005D): X=69.0,Y=-1.0 (should be at baseline 0?)
	* bracketright (U+005D): X=173.0,Y=-1.0 (should be at baseline 0?)
	* bracketright (U+005D): X=313.0,Y=702.0 (should be at cap-height 700?)
	* bracketright (U+005D): X=209.0,Y=702.0 (should be at cap-height 700?)
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	* parenleft (U+0028) contains a short segment L<<573.0,800.0>--<571.0,791.0>>
	* parenright (U+0029) contains a short segment L<<-26.0,-100.0>--<-24.0,-91.0>>
	* paragraph (U+00B6) contains a short segment L<<292.0,286.0>--<277.0,286.0>>
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	* parenleft (U+0028) contains a short segment L<<560.0,800.0>--<559.0,792.0>>
	* parenright (U+0029) contains a short segment L<<-26.0,-100.0>--<-25.0,-92.0>>
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* parenright (U+0029) contains a short segment L<<38.0,-100.0>--<38.0,-90.0>>
	* yen (U+00A5) contains a short segment L<<246.0,232.0>--<246.0,245.0>>
	* yen (U+00A5) contains a short segment L<<381.0,246.0>--<381.0,232.0>>
	* paragraph (U+00B6) contains a short segment L<<285.0,281.0>--<268.0,281.0>>
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* jcircumflex (U+0135): X=48.0,Y=2.0 (should be at baseline 0?)
	* jcircumflex (U+0135): X=109.0,Y=1.0 (should be at baseline 0?)
	* jcircumflex (U+0135): X=48.0,Y=2.0 (should be at baseline 0?)
